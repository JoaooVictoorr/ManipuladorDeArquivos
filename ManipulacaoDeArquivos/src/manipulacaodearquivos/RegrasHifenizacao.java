            ...
            {  
               ...
               if(vc.VerificarVogal(tp.transferencia[j]))
               {
                 ...
                 escrever.append(tp.transferencia[j]);
                  ...
                  {
                      if(!vc.VerificarVogal(tp.transferencia[j+1])&& tp.transferencia[j+1] != 'n' && tp.transferencia[j+1] != 's' && tp.transferencia[j+1] != 'n' && tp.transferencia[j+1] != 'c' && tp.transferencia[j+1] != 'p' &&  tp.transferencia[j+1] != 'd' &&  tp.transferencia[j+1] != 'g' &&  tp.transferencia[j+1] != 'x' && tp.transferencia[j+1] != 'r' )
                      {
                       escrever.append(tp.transferencia[j]);
                       escrever.append('-');
                      }
                   ...
                   else if(j != fim && j-1 != 0 && j-2 >= 0)
                  {
                      ...
                      else if (j + 3 <= fim && !vc.VerificarVogal(tp.transferencia[j+2]) && tp.transferencia[j+1] == 'm' || tp.transferencia[j+1] == 's' )
                      {
                          escrever.append(tp.transferencia[j]);
                      }
                      ...
                      else if(j != 0 && j + 1 <= fim && vc.VerificarVogal(tp.transferencia[j-1]) && !vc.VerificarVogal(tp.transferencia[j+1]) && tp.transferencia[j+1] != 'r')
                      {
                          escrever.append(tp.transferencia[j]);
                          escrever.append('-');
                      }
                   ...
                   else if(!vc.VerificarVogal(tp.transferencia[j-1]) && !vc.VerificarVogal(tp.transferencia[j+1]) && tp.transferencia[j+1] != 's')
                   {
                       ...
                       else if(j + 2 <= fim && tp.transferencia[j+1] == 'r' ||  tp.transferencia[j+1] == 'm' ||  tp.transferencia[j+1] == 'n' || tp.transferencia[j+1] == 'l' )
                      {
                       ...
                       {
                           if(!vc.VerificarVogal(tp.transferencia[j-1]) && !vc.VerificarVogal(tp.transferencia[j+1]) && tp.transferencia[j+1] != 't')
                           {
                             escrever.append(tp.transferencia[j]);
                             escrever.append('-');
                           }
              ...
              else
              {
                ...
                else if( j + 1 <= fim && j != 0 && tp.transferencia[j] == 'n')
                {
                    ...
                    else if(j + 1 <= fim && !vc.VerificarVogal(tp.transferencia[j+1]))
                    {
                        escrever.append(tp.transferencia[j]);
                        escrever.append('-');
                    }
                 ...
                 else if(tp.transferencia[j] == 'm')
                {
                   ...
                   else if(tp.transferencia[j] == 'l')
                   {
                    ...
                    else if( j - 2 >=0 && j + 1 <= fim && tp.transferencia[j] == 'r' && vc.VerificarVogal(tp.transferencia[j+1]) && vc.VerificarVogal(tp.transferencia[j-1]) && tp.transferencia[j-2] != 'v')
                    {
                        escrever.append('-');
                        escrever.append(tp.transferencia[j]);
                    }
